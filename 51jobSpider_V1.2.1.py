...
for p in range(startPage,endPage+1):
    targetAddress = 'https://search.51job.com/list/120300,000000,0000,00,9,99,%s,2,%d.html?lang=c&postchannel=0000&workyear=99&cotype=99&degreefrom=99&jobterm=99&companysize=99&ord_field=0&dibiaoid=0&line=&welfare='%(targetPosition, p)
